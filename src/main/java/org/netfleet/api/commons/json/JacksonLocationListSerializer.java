...
public class JacksonLocationListSerializer extends StdSerializer<LocationList> {
  ...
  @Override
  public void serialize(LocationList locations, JsonGenerator gen, SerializerProvider provider) throws IOException {
    ...
    if (locations.getLocations() != null) {
      for (Location location: locations.getLocations()) {
        String featureJson = mapper.writeValueAsString(location);
